...
public class UIHoverFightToPic : UIHover
{
    ...
    public GameObject textToClose3;
    public GameObject textToClose4;


    public GameObject panelResourcePic;
    public GameObject picToOpen;
    public GameObject picToClose;
    ...
    public override void OnPointerEnter(PointerEventData pointerEventData)
    {
        ...
        panelResourcePic.SetActive(false);
        picToClose.SetActive(false);
        picToOpen.SetActive(true);

        textToChangeTo.SetActive(true);
        textToClose1.SetActive(false);
        textToClose2.SetActive(false);
        textToClose3.SetActive(false);
        textToClose4.SetActive(false);
